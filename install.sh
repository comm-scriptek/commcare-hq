...
POSTGRES_DB="scriptek_commcare"
POSTGRES_USER="django"
POSTGRES_PW="django"

COUCHDB_DB="scriptek_commcare"
...
if [ ! -f /etc/init.d/couchdb ]; then
    if [ ! -f apache-couchdb-1.3.1.tar.gz ]; then
        wget http://apache.mirrors.pair.com/couchdb/1.2.1/apache-couchdb-1.3.1.tar.gz
    fi
